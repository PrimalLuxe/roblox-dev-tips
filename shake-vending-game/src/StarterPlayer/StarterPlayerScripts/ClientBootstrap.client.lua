...
local UI=require(Controllers.UIController);local Drop=require(Controllers.DropVisualController);local Machine=require(Controllers.MachineController);local Trade=require(Controllers.TradeController);local Inspect=require(Controllers.InspectController);local Audio=require(Controllers.AudioController);local Onboarding=require(Controllers.OnboardingController);local Showcase=require(Controllers.ShowcaseController);local WorldLoop=require(Controllers.WorldLoopController)
...
Machine.Audio=Audio;Machine:Init(events);Showcase:Init();WorldLoop:Init(events,functions,UI);UI.OnSnapshotChanged=function(snapshot)Machine:SetSnapshot(snapshot);WorldLoop:RefreshHud()end;Machine:SetSnapshot(UI.Snapshot)
