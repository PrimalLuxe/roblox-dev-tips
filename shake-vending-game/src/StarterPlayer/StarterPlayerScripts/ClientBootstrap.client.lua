...
local function requireRemote(className,name)local obj=remotesFolder:WaitForChild(name,12);if not obj or not obj:IsA(className)then error(string.format("[ShakeVM] Missing %s %s",className,name))end;return obj end
